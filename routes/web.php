...
Route::get('/chat-messages/contacts', ['as'=>'messages.fetchusers', 'uses' => 'MessageController@fetchContacts']);
Route::delete('/chat-messages/{id}', ['as'=>'messages.clearuser', 'uses' => 'MessageController@clearUser']);
