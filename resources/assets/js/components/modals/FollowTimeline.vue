    ...
    <transition name="quick-fade" mode="out-in">
      <b-card-body>
        <div>
          <b-row>
            <b-col class="mb-2">
              <p><fa-icon :icon="['fas', 'check']" /> Get access to purchase content</p>
              <p><fa-icon :icon="['fas', 'check']" /> Upgrade to full access anytime</p>
          ...
          <b-button @click="doFollow" :disabled="isInProcess" variant="primary" class="w-100 mb-3">
