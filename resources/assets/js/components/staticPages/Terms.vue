<template>
  <div class="container static-page-layout">
    <b-card class="terms-card mt-5">
      <b-card-title class="mt-3">Beta Testing Agreement Terms & Conditions</b-card-title>
      <div class="mt-5">
        <p>Scope of Agreement. Beta Customer is being granted rights under this Agreement for the purpose of testing and providing input and other Feedback to AllFans regarding one or more of AllFans’s proprietary, non-commercially available hosted software applications, application platform interfaces, services, features and/or functionalities in connection with the Existing Account as more fully described in the Beta Testing Order Form (the “Beta Product(s)”). This Agreement covers all Beta Products made available to Beta Customer by AllFans, including, without limitation, any Beta Products specifically identified by AllFans as being in “Beta” or any similar stage of development. AllFans retains sole and absolute discretion as to what, if any, Beta Products will be made available to Beta Customer during the Term. While Beta Customer is not required to utilize or enable any Beta Products, if Beta Customer elects to do so, then Beta Customer’s use of and access to any such Beta Products shall be subject to the terms of this Agreement.</p>
        <p>Payment; Fees. AllFans reserves the right to charge fees for use and access to the Beta Products or may provide the Beta Products for no charge. AllFans reserves the right to start charging or revise fee amounts at any time, at its sole discretion, under this Agreement or after the Beta Products are made widely available and incorporated into a AllFans service.</p>
        <p>Limited Use Rights. For the term of the Agreement, AllFans grants to Beta Customer a limited, non-transferable, non-exclusive, revocable right to access and use the Beta Product(s) in connection with an Existing Account to test its functionality and provide Feedback to AllFans. AllFans hosts and retains physical control over the Beta Product(s) and only makes the Beta Product(s) available for access and use by Beta Customer over the Internet through a Web-browser or mobile device. Nothing in this Agreement obligates AllFans to deliver or make available any copies of computer programs or code from the Beta Product(s) to Customer, whether in object code or source code form. AllFans reserves the right, in its sole discretion, to revoke access and use of the Beta Products at any time. Further, AllFans reserves the right to enter (“assume into”) the Existing Account as needed to (i) monitor or measure use of the Beta Product(s); (ii) validate certain features or functionality of the Beta Product(s); and (iii) to provide services or support necessary to maintain the Beta Product(s).</p>
        ...
        <p>Feedback. Upon reasonable request by AllFans, Beta Customer agrees to provide suggestions, enhancement requests, and recommendations (individually and collectively, “Feedback”) regarding the Beta Product(s). Feedback shall include informing AllFans about the performance, ease of use, features that may be missing, and any bugs encountered during the use of the Beta Product(s). AllFans may contact Beta Customer and Beta Customer agrees to make available a reasonable amount of time to discuss the Beta Product(s) with AllFans if so requested. AllFans may without restriction or fee use, modify and incorporate this Feedback into the Beta Product(s) and other AllFans products and/or services without any restriction and without any payment.</p>
        <p>Intellectual Property. The parties acknowledge that this Agreement does not transfer any right, title or interest in any intellectual property right to the other. AllFans maintains all rights, title and interest in and to all its patents, inventions, copyrights, trademarks, domain names, trade secrets, know-how and any other intellectual property and/or proprietary rights (collectively, “Intellectual Property Rights”). The limited rights granted to Customer to access and use the Beta Product(s) under this Agreement do not convey any additional rights in the Beta Product(s), or in or to any Intellectual Property Rights associated therewith. Subject only to the limited rights to access and use the Beta Product(s) as expressly provided herein, all rights, title and interest in and to the Beta Product(s) and all hardware, software and other components of or used to provide the Beta Product(s), including all related Intellectual Property Rights, will remain with and belong exclusively to AllFans.</p>
        <p>Term of Agreement and Renewal. This Agreement shall commence upon the Beta Testing Start Date and shall expire on the Beta Testing End Date, each as set forth in the Beta Testing Order Form (the “Initial Term”). Upon expiration, this Agreement shall automatically renew for subsequent one (1) month periods until terminated by either party (each a “Renewal Term” and, collectively with the Initial Term, the “Term”).</p>
        <p>Termination and Expiration. Either party may terminate this Agreement at any time, for any or no reason, and at either party’s convenience by providing written notice to the other. Upon termination of this Agreement, Customer will notify its Users that their access to the Beta Product(s) has terminated, and AllFans may withhold, remove or discard any content, data, or other information that Customer’s Users post or upload into AllFans’s system while using the Beta Product(s). Following termination or expiration of this Agreement, AllFans is not obligated to store, maintain or provide a copy of any content, data or other information that Customer or its Users made available or provided when using the Beta Product(s). If not earlier terminated, Customer’s obligations under this Agreement shall terminate upon termination of this Agreement; provided that the foregoing shall not limit AllFans’s rights pursuant to Section 5 as related to any Feedback provided before or after such termination. Sections 2, 5, 6, 11, and 13 to 17, and all obligations thereunder, shall survive any termination of this Agreement.</p>
        <p>Users. Customer will not, and will not permit its Users to, share Beta Product access rights with any other individual. Customer will ensure that its Users comply with the AllFans’ Terms of Use, which are hereby incorporated into this Agreement. In the event a User violates the TOU, AllFans may suspend and / or terminate Customer’s access to the Beta Product(s).</p>
        <p>Suspension of Services. AllFans may immediately suspend Customer or one of its User’s access to and use of the Beta Product(s) if Customer or one of its Users is in breach of Section 9, provided that the suspension will continue only for as long as reasonably necessary for Customer to remedy the breach.</p>
        <p>Confidential Information. Customer acknowledges and agrees that participation in the Beta testing under this Agreement will result in AllFans disclosing certain confidential, proprietary and/or trade secret information related to the Beta Products and/or AllFans (the “Confidential Information”). Such Confidential Information includes, without limitation, the features, functionality and existence of the Beta Product(s), and any know how, trade secrets, computer programs, source code, flowcharts, diagrams, manuals, schematics, development tools, specifications, design documents, marketing information, financial information, business plans or reports made available to Customer. Customer agrees that it will not, without the express prior written consent of AllFans, disclose any Confidential Information or any part thereof to any third party, except to the extent that such Confidential Information (a) is or becomes generally available to the public through any means other than as a result of any act or omission by Customer; (b) is rightfully received by Customer from a third party that is not subject to any obligation of confidentiality with respect thereto and without limitation as to its use; or (c) is independently developed by Customer without any reliance on any Confidential Information. At the termination of this Agreement or at any time by request of AllFans, Customer will return all Confidential Information in its possession to AllFans and further agrees that it will not duplicate, translate, modify, copy, print, disassemble, decompile or otherwise tamper with the Beta Product(s) or any Confidential Information.</p>
        <p>Third Party Tool Integrations. If applicable, one or more Beta Products may integrate with third party services. Beta Customer hereby consents to the sharing of the information in the Beta Products with these third party services and certifies that it has any and all required consents for doing so.</p>
        <p>Disclaimer of Warranties. THE BETA PRODUCT(S) ARE PROVIDED “AS IS”. ALLFANS MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED, REGARDING THE BETA PRODUCT(S), INCLUDING ANY REPRESENTATION THAT THE SERVICES THEREUNDER WILL BE UNINTERRUPTED OR ERROR-FREE. TO THE FULLEST EXTENT PERMITTED UNDER APPLICABLE LAW, ALLFANS DISCLAIMS ANY IMPLIED OR STATUTORY WARRANTY, INCLUDING ANY IMPLIED WARRANTY OF TITLE, NON-INFRINGEMENT, MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE IN RESPECT OF THE BETA PRODUCT(S). FOR THE AVOIDANCE OF DOUBT, ALL BETA PRODUCT(S) ARE PRELEASE, ARE EXPECTED TO CONTAIN DEFECTS WHICH MAY BE MATERIAL, AND ARE NOT EXPECTED TO OPERATE AT THE LEVEL OF PERFORMANCE OR COMPATIBILITY OF A FINAL, GENERALLY AVAILABLE PRODUCT OFFERING. BETA PRODUCT(S) MAY NOT OPERATE ACCURATELY AND MAY BE SUBSTANTIALLY MODIFIED PRIOR TO PUBLIC AVAILABILITY OR WITHDRAWN AT ANY TIME. ACCORDINGLY, ACCESS TO AND USE OF THE BETA PRODUCT(S) IS ENTIRELY AT CUSTOMER’S OWN RISK. IN NO EVENT SHALL ALLFANS BE LIABLE FOR ANY DAMAGE WHATSOEVER ARISING OUT OF THE USE OF OR INABILITY TO USE THE BETA PRODUCT(S), EVEN IF ALLFANS HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. YOU ARE ADVISED TO SAFEGUARD IMPORTANT DATA, TO USE CAUTION AND NOT TO RELY IN ANY WAY ON THE CORRECT FUNCTIONING OR PERFORMANCE OF ANY BETA PRODUCT.</p>
      ...
      <div class="mt-5">
        ...
        <p>4. Subscriptions and Purchases</p>
        ...
        href="https://twitter.com/tos">https://twitter.com/tos</a></span></p>
        ...
        and slogans on the Website are the trademarks of their respective owners.</p>
        ...
        app; breaching or circumventing firewall, encryption, security or
        authentication routines; accessing information not intended for you, or
        accessing another user's account that you are not expressly authorized to
        access;</p>
        ...
        all other reasonable professional costs and expenses suffered or incurred
        ...
        <p style="margin-top:0in;margin-right:0in;
        margin-left:1.0in;text-align:justify;text-indent:-.5in;">12.1  To
        comply with the U.S. Digital Millennium Copyright Act (Title 17, United States
        ...
        <p style="margin-top:0in;margin-right:0in;
        margin-left:1.0in;text-align:justify;text-indent:-.5in;">12.3  Under
        ...
        <p style="margin-top:0in;margin-right:0in;
        margin-left:1.0in;text-align:justify;text-indent:-.5in;">12.4  If
        we remove or disable access to your Content in response to a DMCA notification
        of claimed copyright infringement, we will make reasonable efforts to notify
        you, and you may make a counter-notification in writing with our Designated
        Agent listed above.</p>
        ...
        are located and that you will accept service of process from the person who
        filed the notice of copyright infringement or an agent of such person.</p>


        <p style="margin-top:0in;margin-right:0in;
        margin-left:1.0in;text-align:justify;text-indent:-.5in;">12.6  If
        we receive a proper counter-notification from you, we will notify the party
        alleging copyright infringement and will reinstate your User Content that was
        removed or disabled within 30&nbsp;business days following our receipt of your
        ...
        <p style="margin-top:0in;margin-right:0in;
        margin-left:1.0in;text-align:justify;text-indent:-.5in;">13.3  You
        ...
        reconstruction of any lost data. To the fullest extent provided by law, we will
