...
<div class="panel panel-default panel-post animated" id="post{{ $post->id }}" style="box-shadow: 0px 0px 0px 0px; margin-bottom: 0px">
...
{{--      <div id="post-image-holder">--}}
{{--          @foreach($post->images() as $image)--}}
{{--          <span class="pip">aaa<img class="thumb-image" src="" title=""/><a data-id=" + (key) + " class='remove-thumb'><i class='fa fa-times'></i></a></span></div>--}}
{{--          @endforeach--}}
