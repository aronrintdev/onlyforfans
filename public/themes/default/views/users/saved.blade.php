										...
										<div class="connect-list">
											<div class="connect-link side-left">
					                            <a href="{{ url($timeline->username) }}">
					                            	<img src=" @if($timeline->avatar_id) {{ $timeline->avatar->filename }} @else {{ url('page/avatar/default-page-avatar.png') }} @endif" alt="{{ $timeline->name }}" title="{{ $timeline->name }}" alt="{{ $timeline->name }}" class="img-icon">
					                            	{{ $timeline->name }}
					                            </a>
				                            </div>
