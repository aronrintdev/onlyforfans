...
<div class="user-bio-block follow-links">
    ...
    @endif
    @if($creator->is_follow_for_free && $creator->id != $sessionUser->id)
    <div class="follow">
        <div class="bio-header">Follow</div>
        <div class="bio-description">
          @if(!$creator->timeline->followers->contains($sessionUser->id))
            <div class="follow-btn">
                <a href="javascript:void(0);" class="btn btn-submit btn-success follow-user follow" style="display:block;" data-price="{{ $creator->price }}" data-follow="1"  data-timeline-id="{{ $timeline->id }}">
                    Follow for Free
                </a>
            </div>
            <div class="unfollow-btn hidden">
                <a href="javascript:void(0);" class="btn btn-submit btn-success unfollow" style="display:block;" data-price="{{ $creator->price }}" data-follow="1"  data-timeline-id="{{ $timeline->id }}">
					Unfollow
                </a>
            </div>
            @else
    ...
    <div class="subscribe">
        ...
        @if(!$creator->timeline->followers->contains($sessionUser->id))
				<div class="left-col">
					<a href="javascript:void(0);" class="btn btn-submit btn-success OFF-follow-user follow clickme_to-show_follow_confirm" style="display:block;" data-price="{{ $creator->price }}"  data-timeline-id="{{ $timeline->id }}">
						<i class="fa fa-heart"></i> {{ trans('common.follow') }}
					</a>
				</div>
				<div class="hidden">
					<a href="#" class="btn btn-submit btn-success unfollow" style="display:block;" data-price="{{ $creator->price }}"  data-timeline-id="{{ $timeline->id }}">
						<i class="fa fa-check"></i> {{ trans('common.following') }}
					</a>
				</div>
			@else
				<div class="hidden">
					<a href="#" class="btn btn-submit btn-success follow-user follow" style="display:block;" data-price="{{ $creator->price }}" data-timeline-id="{{ $timeline->id }}">
						<i class="fa fa-heart"></i> {{ trans('common.follow') }}
					</a>
				</div>
				<div class="left-col">
