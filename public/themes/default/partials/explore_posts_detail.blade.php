                            ...
                            <ul class="list-inline footer-list">
                                ...
                                @if(Auth::user()->id != $post->user_id)
                                    @if(!$post->users_shared->contains(Auth::user()->id))
                                        ...
                                        <li class="follow-links {{ $post->user->followers->contains(Auth::user()->id) ? 'hidden' : '' }}">
                                            <a href="#" class="follow-user follow" data-price="{{ $post->user->price }}" data-timeline-id="{{ $post->user->timeline->id }}"> <i class="fa fa-heart"></i> {{ trans('common.follow') }}</a>
                                        </li>
                                    @else
