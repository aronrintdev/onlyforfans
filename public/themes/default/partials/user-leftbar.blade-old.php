<div class="user-profile-buttons">
	<div class="row follow-links pagelike-links">
		...
		<?php 
		//check user's follow_privacy settings
		$user_follow ="";
		$confirm_follow ="";
		$message_privacy ="";						
...
{{--			@endif--}}
        		...
        		@else
        		<!-- <div class="col-md-12">
        		    <a href="{{ url('/'.Auth::user()->username.'/settings/profile') }}" class="btn btn-profile">
        		        <i class="fa fa-pencil-square-o"></i>{{ trans('common.edit_profile') }}
        		    </a>
        		</div> -->
        		@endif <!-- End of [if-1]-->
	</div>
