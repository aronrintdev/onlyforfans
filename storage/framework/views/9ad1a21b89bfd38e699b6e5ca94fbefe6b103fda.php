...
<div class="timeline-cover-section">
	<div class="timeline-cover">
		...
		<ul class="list-inline pagelike-links">							
			...
			<?php else: ?>
				<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'posts' ? 'active' : ''); ?>"><a href="#"><span class="top-list"><?php echo e(count($timeline->posts()->where('active', 1)->get())); ?> <?php echo e(trans('common.posts')); ?></span></a></li>
			<?php endif; ?>
			...
			<?php endif; ?>
			<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'following' ? 'active' : ''); ?>">
			...
			<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'followers' ? 'active' : ''); ?>">
				<a href="#" ><span class="top-list"><?php echo e(0); ?>  <?php echo e(trans('common.likes')); ?></span>
				</a>
			</li>
			<?php if($follow_confirm == "yes" && $timeline->id == Auth::user()->timeline_id): ?>
				<li class="timeline-cover-status <?php echo e(Request::segment(2) == 'follow-requests' ? 'active' : ''); ?>">
