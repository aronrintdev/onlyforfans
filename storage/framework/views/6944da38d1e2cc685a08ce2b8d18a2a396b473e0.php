...
<?php endif; ?>
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand socialite" href="">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-4">
			...
			<ul class="nav navbar-nav navbar-right" id="navbar-right" v-cloak>
				...
				<li class="<?php echo (Request::segment(1)=='' ? 'active' : ''); ?>"><a href="<?php echo e(url('/')); ?>"><i class="fa fa-comments" aria-hidden="true"></i></a></li>

				<?php if(Setting::get('enable_browse') == 'on'): ?>
					<li class="<?php echo (Request::segment(1)=='browse' ? 'active' : ''); ?>"><a href="<?php echo e(url('/browse')); ?>" class="btn menu-btn"><i class="fa fa-globe" aria-hidden="true"></i> </a></li>
				<?php endif; ?>

				<li><a href="<?php echo e(url(Auth::user()->username.'/saved')); ?>" class="btn menu-btn"><i class="fa fa-save" aria-hidden="true"></i> </a></li>

				<li><a href="<?php echo e(url('/'.Auth::user()->username.'/settings/general')); ?>" class="btn menu-btn"><i class="fa fa-cog" aria-hidden="true"></i></a></li>
							...
							<ul class="dropdown-menu">
								...
								<li>
									<form action="<?php echo e(url('/logout')); ?>" method="post">
										...
										<button type="submit" class="btn-logout"><i class="fa fa-unlock" aria-hidden="true"></i>Add Bank</button>
									</form>
								</li>
								...
								<li>
									<form action="<?php echo e(url('/logout')); ?>" method="post">
										...
										<button type="submit" class="btn-logout"><i class="fa fa-unlock" aria-hidden="true"></i>Add Payment</button>
									</form>
								</li>
								<li>
									<form action="<?php echo e(url('/logout')); ?>" method="post">
