			...
			<div class="fans-form">
				...
				<form method="POST" action="<?php echo e(url('admin/general-settings')); ?>" enctype="multipart/form-data" files="true">
					...
					<div class="row">
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								<?php echo e(Form::text('site_name', Setting::get('site_name', 'fans'), array('class' => 'form-control', 'placeholder' => trans('admin.site_name') ))); ?>
						...
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								<?php echo e(Form::text('site_title', Setting::get('site_title', 'fans'), array('class' => 'form-control', 'placeholder' => trans('admin.site_title')))); ?>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<img id="logo" class="fans-logo" src="<?php echo e(url('setting/'.Setting::get('logo'))); ?>" alt="fans logo" title="fans logo"/>
						</div>
						<div class="col-md-3">
							<fieldset class="form-group">
						...
						<div class="col-md-3">
							<img id="favicon" class="fans-favicon" src="<?php echo e(url('setting/'.Setting::get('favicon'))); ?>" alt="fans favicon" title="fans favicon" height="50" />
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								<?php echo e(Form::email('support_email', Setting::get('support_email', 'admin@fans.com'), array('class' => 'form-control'
						...
						<div class="col-md-6">
							<fieldset class="form-group">
								...
								<?php echo e(Form::email('noreply_email', Setting::get('noreply_email', 'noreply@fans.com'), array('class' => 'form-control'
