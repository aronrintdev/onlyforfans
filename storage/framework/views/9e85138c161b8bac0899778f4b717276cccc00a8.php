					...
					<div class="panel-body nopadding">
						<div class="fans-form">
							<form  method="POST" action="<?php echo e(url('/'.$username.'/settings/save-bank-details')); ?>" class=".bank-details">
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required <?php echo e($errors->has('country') ? ' has-error' : ''); ?>">
											...
											<?php echo e(Form::text('country', Auth::user()->payment != NULL ? Auth::user()->country : '', array('class' => 'form-control', 'placeholder' => trans('common.country')))); ?>
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required <?php echo e($errors->has('bank_address') ? ' has-error' : ''); ?>">
											<?php echo e(Form::label('bank_address', trans('Street Address'))); ?>

											<?php echo e(Form::text('bank_address', Auth::user()->payment != NULL ? Auth::user()->address : '', ['class' => 'form-control', 'placeholder' => trans('Street Address')])); ?>
									...
									<div class="col-md-6">
										<fieldset class="form-group required <?php echo e($errors->has('city') ? ' has-error' : ''); ?>">
											...
											<?php echo e(Form::text('city', Auth::user()->payment != NULL ? Auth::user()->city : '', ['class' => 'form-control', 'placeholder' => trans('City')])); ?>
								...
								<div class="row">
									<div class="col-md-6">
										<fieldset class="form-group required <?php echo e($errors->has('state') ? ' has-error' : ''); ?>">
											...
											<?php echo e(Form::text('state', Auth::user()->payment != NULL ? Auth::user()->city : '', ['class' => 'form-control', 'placeholder' => trans('State/Province')])); ?>
									...
									<div class="col-md-6">
										<fieldset class="form-group required <?php echo e($errors->has('zip') ? ' has-error' : ''); ?>">
											...
											<?php echo e(Form::text('zip', Auth::user()->payment != NULL ? Auth::user()->zip : '', ['class' => 'form-control', 'placeholder' => trans('Zip/Postal Code')])); ?>
								...
								<div class="row">
									<div class="col-md-10">
										<fieldset class="form-group <?php echo e($errors->has('sell_content_confirm') ? ' has-error' : ''); ?>">
											...
											<?php echo e(Form::label('sell_content_confirm', trans('Yes, my account will contain explicit or adult content'))); ?>
