...
<div class="list-group list-group-navigation socialite-group">
	...
	<a href="<?php echo e(url('/'.Auth::user()->username.'/settings/addbank')); ?>" class="list-group-item">
		<div class="list-icon socialite-icon <?php echo e(Request::segment(3) == 'addbank' ? 'active' : ''); ?>">
	...
	<a href="<?php echo e(url('/'.Auth::user()->username.'/settings/addpayment')); ?>" class="list-group-item">
		<div class="list-icon socialite-icon <?php echo e(Request::segment(3) == 'addpayment' ? 'active' : ''); ?>">
