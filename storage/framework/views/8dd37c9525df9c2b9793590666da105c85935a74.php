                                ...
                                <?php if(Setting::get('enable_browse') == 'on'): ?>
                                    ...
                                    <li class="dropdown user-image fans">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class=""><a href="<?php echo e(url('/faq')); ?>"><i class="fa fa-question" aria-hidden="true"></i>Help & FAQ</a></li>

                                            <li class=""><a href="<?php echo e(url('/support')); ?>"><i class="fa fa-envelope" aria-hidden="true"></i>Support</a></li>
