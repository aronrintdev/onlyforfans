...
class NewSubPaymentReceived extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line("You received a subscription payment in the amount of ".$this->amount->getAmount())
    ...
    {
        return [
            'template_id' => 'new-subscription-payment-received',
            'to' => [
