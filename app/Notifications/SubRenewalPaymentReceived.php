...
class SubRenewalPaymentReceived extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->line("You received a subscription renewal payment in the amount of ".$this->amount->getAmount())
    ...
    {
        return [
            'template_id' => 'subscription-renewal-payment-received',
            'to' => [
